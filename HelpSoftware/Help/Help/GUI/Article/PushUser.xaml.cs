...
namespace Help
{
  public partial class PushUser : HelpUserControl
  {
    public PushUser()
    {
      InitializeComponent();
    ...
    private void SendPushMail(ArticleNomination nom)
    {
      ...
      string MailMessage = String.Format(EMailTemplates.NominatedForArticle, FullNameRecipient,
                               ...
                               nom.Comment);
      AppContext.MailHandlerInstance.SendPushEMail(MailMessage, "You have been Nominated to write Article " + nom.ArticleTitle, nom.NominatedUser.EMail, EMailType.Nominated);
    }
