namespace Help.Library
{
  public static class EMailTemplates
  {
    ...
    public static string UserCommentedYourArticle = @"<h1 style = ""color: #5e9ca0;"">Hey {0}</h1>
                  <h2 style = ""color: #2e6c80;"" >{1} Has Commented on Your Article: {2}</h2>
                  <p><h2>His Comment is:</h2></p>
                  <p>{3}</p>
				          <p>Thank You and...</p>
                  <p><strong>the help Team</strong></p>
                  <hr/>
    ...
    public static string UserIssuedWrongTranslation = @"<h1 style = ""color: #5e9ca0;"">Hey {0}</h1>
                  <h2 style = ""color: #2e6c80;"" >{1} Has Issued a wrong Translation<h2>
                  <p><h2>He thinks the word ""{2}"" Should be ""{3}""</h2></p>
                  <p>His Comment ist</p>
                  <p>{4}</p>
				          <p>Thank You and...</p>
                  <p><strong>the help Team</strong></p>
