...
{
  public class RibbonGroupBoxZwischenAblage
  {
    public RibbonGroupBoxDef RibbonGroupBoxDef { get; set; }

    public RibbonGroupBoxZwischenAblage()
    {
      RibbonGroupBoxDef = new RibbonGroupBoxDef()
      {
        Name = "RibbonGroupBoxZwischenAblage",
    ...
    private void LoadButtonForGroupBox()
    {
      ...
      //Suchen
      //Löschen
      RibbonGroupBoxDef.RibbonButtonDefs.Add(LoadReferencedButton("RibbonButtonInsert"));
